...
export default function ExpertCard({
  ...
  return (
    <div className="bg-white w-full lg:w-87.5 m-2 h-full min-h-fit flex flex-col md:flex-row lg:flex-col justify-between rounded-3xl overflow-hidden text-[#739FEC] shadow-xl border-2 border-white">
      {/* Expert Image */}
      <div
